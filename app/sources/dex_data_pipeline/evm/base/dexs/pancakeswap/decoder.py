...
# ✅ Use Base RPC
w3 = get_web3_client(BASE_RPC_URL)
...
@celery_app.task(name="base_pancakeswap_decode_log_chunk")
def decode_log_chunk(logs_chunk, block_cache, abi, dec0: int, dec1: int, base_is_token1):
    """
    Decode a chunk of logs from PancakeSwap on Base. Runs in its own Celery worker.
    """
